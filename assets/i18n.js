(function () {
  ...
  var dict = {
    en: {
      ...
      'demo.sub': 'The nickname is at the top. Subject is sender number → recipient number. Your registered email is To. The forwarding time is the date. Not a word is changed.',
    ...
    zh: {
      ...
      'demo.h2': '原始对话，完整呈现。',
      'demo.sub': '最上面是短信发送人的昵称。主题是发送号码 → 接收号码。收件人是注册邮箱。日期是转发时间。内容一个字没变。',
      'demo.pick': '选择示例联系人',
